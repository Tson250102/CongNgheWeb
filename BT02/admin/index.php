    ...
    <div class="container-fluid d-flex">
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<td><a href="" data-bs-toggle="modal" data-bs-target="#exampleModal""><i class="bi bi-trash-fill btn btn-danger"></i></a></td>'; 
                echo "</tr>";
            }
        } else {
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <?php 
                    $id = "SELECT userid FROM user"
                ?>
                <h1 class="modal-title fs-5" id="exampleModalLabel">Delete <?php echo $id ?></h1>
